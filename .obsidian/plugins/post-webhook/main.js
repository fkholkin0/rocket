...
var PayloadService = class {
  static createPayload(content, filename, filepath, attachments, file, selectedText, variableNote, processInlineFields = false) {
...
var WebhookService = class {
  static async sendContent(app, webhookUrl, content, filename, file, selectedText, isSelectionCommand = false) {
    if (!webhookUrl) {
